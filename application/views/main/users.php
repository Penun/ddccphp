<div ng-show="mainCont.CurOverScreen(1)" class="sixty_he">
	<div class="left_page_col left_page">
		<div class="left_page_col fade_in">
			<h2>Players</h2>
			<img src="<?php echo base_url(); ?>static/img/pencil_underline.png" class="p_underline" />
			<ul>
	...
	<div class="right_page fade_nu" id="detail_col">
		...
		<img src="<?php echo base_url(); ?>static/img/pencil_underline.png" class="p_underline_f" />
		<?php $this->load->view("main/characters.php"); ?>
	</div>
</div>
